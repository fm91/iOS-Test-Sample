...
int cellHeight;   //since we want the cell to resize according to its content then it should be a variable
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cellHeight = [cell loadWithData:chatData]; //I've changed the method to return the appropriate height
